...
PageResult<T> _page<T>(Map<String, dynamic> data, T Function(Map<String, dynamic>) fromJson, int size) {
  return PageResult(
...
class ApiGenreRepository implements GenreRepository {
  ...
  Future<Genre> create(Genre genre) => guard(() async {
        final response = await _dio.post<Map<String, dynamic>>('/genres', data: genre.toJson());
        return Genre.fromJson(response.data ?? const {});
      });

  @override
  Future<Genre> update(Genre genre) => guard(() async {
        final response = await _dio.put<Map<String, dynamic>>('/genres/${genre.id}', data: genre.toJson());
        return Genre.fromJson(response.data ?? const {});
      });
  ...
  Future<int> deleteMany(List<int> ids) => guard(() async {
        final response = await _dio.post<Map<String, dynamic>>('/genres/bulk-delete', data: {'ids': ids});
...
class ApiPublisherRepository implements PublisherRepository {
  ...
  Future<Publisher> create(Publisher publisher) => guard(() async {
        final response = await _dio.post<Map<String, dynamic>>('/publishers', data: publisher.toJson());
        return Publisher.fromJson(response.data ?? const {});
      });

  @override
  Future<Publisher> update(Publisher publisher) => guard(() async {
        final response = await _dio.put<Map<String, dynamic>>('/publishers/${publisher.id}', data: publisher.toJson());
        return Publisher.fromJson(response.data ?? const {});
      });
  ...
  @override
  Future<void> hardDelete(int id) =>
      guard(() => _dio.delete('/publishers/$id', queryParameters: {'hard': true}));
  ...
  @override
  Future<int> deleteMany(List<int> ids) => guard(() async {
        final response = await _dio.post<Map<String, dynamic>>('/publishers/bulk-delete', data: {'ids': ids});
        return (response.data?['deleted'] as int?) ?? 0;
      });
}
...
class ApiReaderRepository implements ReaderRepository {
  ...
  Future<Reader> create(Reader reader) => guard(() async {
        final response = await _dio.post<Map<String, dynamic>>('/readers', data: reader.toJson());
        return Reader.fromJson(response.data ?? const {});
      });

  @override
  Future<Reader> update(Reader reader) => guard(() async {
        final response = await _dio.put<Map<String, dynamic>>('/readers/${reader.id}', data: reader.toJson());
        return Reader.fromJson(response.data ?? const {});
      });
  ...
  @override
  Future<int> deleteMany(List<int> ids) => guard(() async {
        final response = await _dio.post<Map<String, dynamic>>('/readers/bulk-delete', data: {'ids': ids});
        return (response.data?['deleted'] as int?) ?? 0;
      });
}
