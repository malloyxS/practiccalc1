...
const seedBooks = [
  ...
  Book(
    id: 21,
    title: 'Деньги как инструмент',
    isbn: '978-5-9614-1234-7',
    year: 2018,
    pages: 288,
    publisherId: 4,
    authorIds: [8],
  ...
  Book(
    id: 23,
    title: 'Капитал для начинающих',
    isbn: '978-5-00146-333-0',
    year: 2020,
    pages: 312,
    publisherId: 5,
    authorIds: [8],
...
final seedReaders = [
  ...
  Reader(
    ...
    lastName: 'Петрова',
    firstName: 'Анна',
    email: 'petrova@mail.test',
    phone: '+7 900 222-33-44',
    card: LibraryCard(
      number: 'LC-1002',
      issuedAt: DateTime(2024, 3, 2),
  ...
  Reader(
    ...
    lastName: 'Кузнецова',
    firstName: 'Мария',
    email: 'kuznetsova@mail.test',
    phone: '+7 900 444-55-66',
    card: LibraryCard(
      number: 'LC-1004',
      issuedAt: DateTime(2025, 2, 14),
      expiresAt: DateTime(2028, 2, 14),
    ),
  ),
  Reader(
    id: 5,
    lastName: 'Орлов',
    firstName: 'Никита',
    email: 'orlov@mail.test',
    phone: '+7 900 555-66-77',
    card: LibraryCard(
      number: 'LC-1005',
      issuedAt: DateTime(2024, 6, 20),
      expiresAt: DateTime(2027, 6, 20),
      active: false,
    ),
  ),
  Reader(
    ...
    lastName: 'Морозова',
    firstName: 'Елена',
    email: 'morozova@mail.test',
    phone: '+7 900 666-77-88',
    card: LibraryCard(
      number: 'LC-1006',
      issuedAt: DateTime(2022, 11, 5),
      expiresAt: DateTime(2025, 11, 5),
    ),
  ),
  Reader(
    id: 7,
    lastName: 'Волков',
    firstName: 'Артём',
    email: 'volkov@mail.test',
    phone: '+7 900 777-88-99',
    card: LibraryCard(
      number: 'LC-1007',
      issuedAt: DateTime(2025, 1, 8),
      expiresAt: DateTime(2028, 1, 8),
    ),
  ),
  Reader(
    id: 8,
    lastName: 'Соколова',
    firstName: 'Дарья',
    email: 'sokolova@mail.test',
    phone: '+7 900 888-99-00',
    card: LibraryCard(
      number: 'LC-1008',
      issuedAt: DateTime(2024, 8, 19),
      expiresAt: DateTime(2027, 8, 19),
    ),
  ),
];
